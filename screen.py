...
enemies = Enemies( 100, 100, screen_width, screen_height)
...
enemy_list = [Enemies(random.randint(0, screen_width - 128), random.randint(800,screen_height ), screen_width, screen_height) for _ in range(5)]
